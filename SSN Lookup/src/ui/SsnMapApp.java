...
import business.RetireeManager;
...
public class SsnMapApp {
     ...
     *
     * @return the number of a specific option or the number of the SSN
     */
    public static long displayMenu() {
        ...
        do {
            ...
            System.out.println(" Enter SSN - Get Monthly Benefits");
            System.out.print("> ");
            try {
    ...
    public static void add() {
        ...
        String name = "";
        do {
            System.out.println("Enter the full name of retiree: ");
            try {
                name = scanner.nextLine();
                if (name.matches("^([A-z\\'\\.-ᶜ]*(\\s))+[A-z\\'\\.-ᶜ]*$")) {
                    checked1 = true;
                } else {
                    System.out.println("Enter full name without symbols or numbers"
                            + " please.");
                    checked1 = false;
                }
            } catch (InputMismatchException ime) {
